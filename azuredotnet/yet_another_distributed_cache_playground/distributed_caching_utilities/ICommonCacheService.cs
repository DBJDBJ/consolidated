...
namespace distributed_caching_utilities
{
    ...
    {
        public ILogger<ICommonCachingService> logger();
            ...
            /// <param name="distributedCacheExpiration">Expiration of cached item on just_distributed_. Can be some bigger TimeSpan.</param>
