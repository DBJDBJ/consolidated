...
from typing import Final # dbjdbj
import hashlib
...
class DiffieHellman(object):
	...
	# dbjdbj: class aka static table of primes
	# you do not want them re-created on making every instance of the class
	# or even worse on entering  getPrimt() each time
	# ps:  mypy will report an error if you try anch chage the Final var:
	primes: Final = {
	...
	# dbjdbj: also made it static and final
	default_group: Final = 17
	...
	def getPrime(self, group=17):
		...
		if group in self.primes.keys():
			return self.primes[group]
		else:
			print("Error: No prime with group %i. Using default." % group)
			return self.primes[self.default_group]
